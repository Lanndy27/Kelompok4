        ...
        <div className="flex items-center justify-between gap-10 border border-solid border-black bg-white-a700 md:flex-row mb-[66px] ">
          ...
          <div className="flex flex-col items-start gap-11 md:px-5">
            ...
            <div className="flex flex-col items-start gap-11">
              ...
              >
                Memilih bahan pakaian pria bukan hanya soal gaya, tetapi juga
                kenyamanan dan kesesuaian. Bahan menentukan kenyamanan saat
                dipakai, kemudahan per awatan, dan cocok atau tidaknya untuk
                berbagai cuaca. Kain katun misalnya, adalah pilihan umum karena
                sifatnya yang adem dan breathable, membuat kamu tetap sejuk di
                cuaca panas dan hangat saat berlapis.{" "}
              </Text>
            </div>
            <ChipView
              options={ChipOptions}
